...
# ani.save(filename="C:\\Users\\nfabr\\OneDrive\\Desktop\\A470\\A470\\HW\\Agent Based\\geese.html", writer=writer)
...
# Create a vpython sphere for every goose
...
while t < time:
    ...
    scene.center = vector(geese.pop[geese.popLead].x[0],geese.pop[geese.popLead].x[1],0)
    t += 1
